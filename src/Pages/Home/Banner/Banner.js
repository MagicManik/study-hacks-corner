...
const Banner = () => {
    return (
        <section>
            ...
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#f8f9fa" fill-opacity="1" d="M0,320L60,272C120,224,240,128,360,112C480,96,600,160,720,197.3C840,235,960,245,1080,213.3C1200,181,1320,107,1380,69.3L1440,32L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path></svg>
            </div>
        </section>
    );
};
